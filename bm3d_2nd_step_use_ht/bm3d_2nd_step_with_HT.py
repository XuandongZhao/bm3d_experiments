...
def bm3d_2nd_step(sigma, img_noisy, img_basic, nWien, kWien, NWien, pWien, tauMatch, useSD, tau_2D, lambdaHard3D):
    ...
    for i_r in row_ind:
        for j_r in column_ind:
            ...
            group_3D, weight = ht_filtering_hadamard(group_3D_est, sigma, lambdaHard3D, not useSD)
