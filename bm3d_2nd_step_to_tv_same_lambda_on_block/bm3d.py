...
def run_bm3d(noisy_im, sigma,
    ...
    img_denoised = bm3d_2nd_step_with_TV(sigma, noisy_im_p, img_basic_p, n_W, k_W, N_W, p_W, tauMatch_W, useSD_W, tau_2D_W, lamb)
...
if __name__ == '__main__':
    ...
    for im_name in ['Lena.png']:
        ...
        for sigma in sigma_list:
            ...
            for lamb in [1, 2, 3, 7, 8, 8.1, 8.3, 8.4, 9, 10]:
